...
export const DOCS: DocMeta[] = [
  {
    ...
    slug: "start-here",
    title: "Start Here",
    summary: "Five-minute on-ramp: what G-BAU-G is, the v3.2 IA, what's live vs planned vs killed, and which doc to read next by role.",
    readTime: "5 min",
    diagramCount: 0,
  },
  {
    ...
    title: "Vision & Pitch",
    summary: "Why G-BAU-G exists, controlled-transparency thesis, the four member-facing surfaces, lean canvas and committee ROI.",
    readTime: "6 min",
    diagramCount: 2,
  },
  {
    ...
    summary: "Strategic goals, monetisation (₹10K Paid + broker flag), Feature Access pilot override, what's in and out of scope.",
    readTime: "7 min",
    diagramCount: 2,
  },
  {
    ...
    slug: "product-and-ux",
    title: "Product & UX",
    summary: "Personas, v3.2 nav shell, dashboard onboarding, RBAC matrix, controlled-transparency rules, community compose behavior.",
    readTime: "8 min",
    diagramCount: 3,
  },
  {
    ...
    summary: "Module-by-module spec: Directory, Storefront, Products, Brands, Community Feed, RFQ, Bulletin, public authority pages, admin CMS + Feature Access.",
    readTime: "9 min",
    diagramCount: 2,
  },
  {
    ...
    summary: "Stack, layering rules, v3.2 data model, auth + RLS (is_features_open, has_role, get_company_whatsapp), edge functions, storage buckets.",
    readTime: "10 min",
    diagramCount: 3,
  },
  {
    ...
    summary: "Environment setup, secrets, seeding + Feature Access, test strategy, prerender/sitemap, PWA, roadmap, operational runbook.",
    readTime: "6 min",
    diagramCount: 2,
  },
  {
  ...
  },
  {
    ...
    summary: "Governing terms for accounts, listings, forum content, payments, liability and disputes.",
    readTime: "7 min",
    diagramCount: 0,
    internal: true,
  },
  ...
  },
  {
    ...
    summary: "Retention schedule per data class, erasure workflow, legal holds.",
    readTime: "6 min",
    diagramCount: 0,
    internal: true,
  },
