...
export const DOCS: DocMeta[] = [
  ...
  },
  {
    ...
    slug: "product-and-ux",
    title: "Product & UX",
    summary: "Personas, RBAC matrix, controlled-transparency UX rules, governance principles. (RFQ lifecycle removed in v3.1.3.)",
    readTime: "8 min",
    diagramCount: 3,
  },
  {
    ...
    summary: "Module-by-module spec for Directory, Storefront, Forum, CMS and acceptance criteria. (RFQ Cart module removed in v3.1.3.)",
    readTime: "9 min",
    diagramCount: 2,
  },
  {
