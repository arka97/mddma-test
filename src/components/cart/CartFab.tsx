...
export function CartFab() {
  ...
  return (
    <Button
      ...
      className="fixed right-6 bottom-[calc(5.5rem+env(safe-area-inset-bottom))] z-40 h-12 w-12 rounded-full shadow-lg sm:h-14 sm:w-14 md:bottom-[calc(1.5rem+env(safe-area-inset-bottom))]"
